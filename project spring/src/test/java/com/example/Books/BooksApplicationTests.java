...
class BooksApplicationTests {
	...
	public void testFindByNomBook() {
		List<Book> prods = BookRepository.findByNomBook("book");

		for (Book p : prods) {
			System.out.println(p.getNomBook()+" "+p.getPrixBook());
		}
	...
	public void testFindByNomBookContains() {
		List<Book> prods = BookRepository.findByNomBookContains("book");

		for (Book p : prods) {
			System.out.println(p.getNomBook());
		}
	}

	@Test
	public void testfindByNomPrix() {
		List<Book> prods = BookRepository.findByNomPrix("book", 12.003);
		for (Book p : prods) {
			System.out.println(p.getNomBook());
		}
	...
	public void findByAuthoridAuthor() {
		...
		List<Book> prods = BookRepository.findByAuthorIdAuthor(3L);
		for (Book p : prods) {
			System.out.println(p.getNomBook());
		}
